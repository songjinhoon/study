...
응답은 https://github.com/mikekelly/hal_specification[Hypertext Application Language (HAL)] 형식을 따른다.
...
operation::create-event[snippets='request-headers,request-fields,curl-request,response-headers,response-fields,http-response,links']
